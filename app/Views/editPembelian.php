...
<body>
            ...
            <div class="relative -mx-4 flex items-center justify-between">
                <div class="w-60 max-w-full px-4">
                    <a href="/" class="block w-full py-5">
                        <img src=<?= base_url("images/logo.jpg") ?> alt="logo" class="w-16" />
                    </a>
                </div>
    ...
    <form action="/pembelian/update" method="POST" enctype="multipart/form-data">
        ...
        <section class="container mt-10">
                ...
                <div class="md:w-1/2">
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <div class="relative">
                                <select name="item_name" class="w-full appearance-none rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]">
                    ...
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input value="<?= $order['qty']; ?>" name="qty" type="number" placeholder="Default Input" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                </div>
                <div class="md:w-1/2">
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input value="<?= $order['price']; ?>" name="price" type="number" placeholder="harga" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <textarea name="address" rows="5" placeholder="address" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"><?= $order['address']; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full px-4 md:w-1/2">
                        <div class="mb-12">
                            ...
                            <input value="<?= $order['name']; ?>" name="name" type="text" placeholder="name" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>                           
