  ...
  <div id="app">
    ...
    <section class="is-hero-bar">
      <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
        ...
        <button class="button light"><a href="/createPembelian">Tambah Pembelian</a></button>
      </div>
    </section>
                  ...
                  <td class="actions-cell">
                    <div class="buttons right nowrap">
                      <button class="button small blue --jb-modal" type="button">
                        <span class="icon"><a href="/Pembelian/edit/<?= $order['id']; ?>"><i class="mdi mdi-eye"></i></a></span>
                      </button>
                      <button class="button small red --jb-modal" type="button">
                        <span class="icon"><a href="/Pembelian/delete/<?= $order['id']; ?>"><i class="mdi mdi-trash-can"></i></a></span>
                      </button>
                    </div>
                  </td>
