                ...
                <div class="md:w-1/2">
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input value="<?= $order['name']; ?>" name="name" type="text" placeholder="Default Input" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                        <div>
                ...
                <div class="md:w-1/2">
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input value="<?= $order['address']; ?>" name="address" type="text" placeholder="Default Input" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="md:w-1/2">
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input value="<?= $order['age']; ?>" name="age" type="text" placeholder="Default Input" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                </div>
