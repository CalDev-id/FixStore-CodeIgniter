...
<body>
    ...
    <form action="/createPembelian" method="POST" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <section class="container mt-10">
                ...
                <div class="md:w-1/2">
                    ...
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input name="qty" type="number" placeholder="Default Input" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                </div>
                <div class="md:w-1/2">
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <input name="price" type="number" placeholder="harga" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                    <div class="w-full px-4">
                        <div class="mb-12">
                            ...
                            <textarea name="address" rows="5" placeholder="address" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full px-4 md:w-1/2">
                        <div class="mb-12">
                            ...
                            <input name="name" type="text" placeholder="name" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>                           
