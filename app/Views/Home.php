...
<body>
                ...
                <div class="w-full px-4 lg:w-5/12">
                    <div class="hero-content">
                        <h1 class="mb-3 text-4xl font-bold leading-snug text-dark sm:text-[42px] lg:text-[40px] xl:text-[42px]">
                            Servis Mobil to The Next <br class="hidden sm:block" />
                            Level dengan FixStore
                        </h1>
                        ...
                        <ul class="flex flex-wrap items-center">
                            <li>
                                <a href="javascript:void(0)" class="inline-flex items-center justify-center rounded-lg bg-slate-800 py-4 px-6 text-center text-base font-normal text-white hover:bg-opacity-90 sm:px-10 lg:px-8 xl:px-10">
                                    Get Started
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="inline-flex items-center justify-center py-4 px-6 text-center text-base font-normal text-body-color hover:text-primary sm:px-10 lg:px-8 xl:px-10">
                                    <span class="mr-2">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="11" cy="11" r="11" fill="#1E293B" />
                        ...
                        <div class="clients pt-16">
                            ...
                            <div class="flex items-center justify-center sm:justify-start">
                                <div class="mr-4 w-20 py-3">
                                    <img src="images/Mercedes-Logo.svg" alt="ayroui" />
                                </div>
                                <div class="mr-4 w-24 py-3">
                                    <img src="images/honda.png" alt="graygrids" />
                                </div>
                                <div class="w-24 py-3">
                                    <img src="images/toyota-logo.png" alt="uideck" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full px-4 lg:w-6/12">
                    <div class="lg:ml-auto lg:text-right">
                        <div class="relative z-10 inline-block pt-11 lg:pt-0">
                            <img src="images/BannerHome2.png" alt="hero" class="rounded-tl-[120px] rounded-lg lg:ml-auto" />
                            <span class="absolute -left-8 -bottom-8 z-[-1]">
                                <svg width="93" height="93" viewBox="0 0 93 93" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="2.5" cy="2.5" r="2.5" fill="#1E293B" />
                                    <circle cx="2.5" cy="24.5" r="2.5" fill="#1E293B" />
                                    <circle cx="2.5" cy="46.5" r="2.5" fill="#1E293B" />
                                    <circle cx="2.5" cy="68.5" r="2.5" fill="#1E293B" />
                                    <circle cx="2.5" cy="90.5" r="2.5" fill="#1E293B" />
                                    <circle cx="24.5" cy="2.5" r="2.5" fill="#1E293B" />
                                    <circle cx="24.5" cy="24.5" r="2.5" fill="#1E293B" />
                                    <circle cx="24.5" cy="46.5" r="2.5" fill="#1E293B" />
                                    <circle cx="24.5" cy="68.5" r="2.5" fill="#1E293B" />
                                    <circle cx="24.5" cy="90.5" r="2.5" fill="#1E293B" />
                                    <circle cx="46.5" cy="2.5" r="2.5" fill="#1E293B" />
                                    <circle cx="46.5" cy="24.5" r="2.5" fill="#1E293B" />
                                    <circle cx="46.5" cy="46.5" r="2.5" fill="#1E293B" />
                                    <circle cx="46.5" cy="68.5" r="2.5" fill="#1E293B" />
                                    <circle cx="46.5" cy="90.5" r="2.5" fill="#1E293B" />
                                    <circle cx="68.5" cy="2.5" r="2.5" fill="#1E293B" />
                                    <circle cx="68.5" cy="24.5" r="2.5" fill="#1E293B" />
                                    <circle cx="68.5" cy="46.5" r="2.5" fill="#1E293B" />
                                    <circle cx="68.5" cy="68.5" r="2.5" fill="#1E293B" />
                                    <circle cx="68.5" cy="90.5" r="2.5" fill="#1E293B" />
                                    <circle cx="90.5" cy="2.5" r="2.5" fill="#1E293B" />
                                    <circle cx="90.5" cy="24.5" r="2.5" fill="#1E293B" />
                                    <circle cx="90.5" cy="46.5" r="2.5" fill="#1E293B" />
                                    <circle cx="90.5" cy="68.5" r="2.5" fill="#1E293B" />
                                    <circle cx="90.5" cy="90.5" r="2.5" fill="#1E293B" />
                                </svg>
                            </span>
                        </div>
                    </div>
        ...
        <section class="bg-[#F3F4F6] pt-20 pb-10 lg:pt-[120px] lg:pb-20">
            <div class=" flex flex-wrap justify-center">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[600px] text-center lg:mb-20">
                        <span class="mb-2 block text-lg font-semibold text-primary">
                            Our Services
                        </span>
                        <h2 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[40px]">
                            Mechanic Everywhere You Are
                        </h2>
                    ...
                    <div class="w-full px-4 md:w-1/2 xl:w-1/3">
                        <div class="mb-10 overflow-hidden rounded-lg bg-white">
                            ...
                            <div class="p-8 text-center sm:p-9 md:p-7 xl:p-9">
                                ...
                                <a href="/pesan" class="inline-block rounded-full border border-[#E5E7EB] py-2 px-7 text-base font-medium text-body-color transition hover:border-primary hover:bg-primary hover:text-white">
                                    View Details
                                </a>
                            </div>
                        </div>
    ...
    <section x-data="{modalOpen: true}">
        <div x-show="modalOpen" x-transition class="fixed z-50 top-0 left-0 flex h-full min-h-screen w-full items-center justify-center bg-black bg-opacity-90 px-4 py-5">
            <div @click.outside="modalOpen = false" class="w-full max-w-[570px] rounded-[20px] bg-white py-12 px-8 text-center md:py-[60px] md:px-[70px]">
                ...
                <span class="mx-auto mb-6 inline-block h-1 w-[90px] rounded bg-slate-800"></span>
                <p class="mb-10 text-base leading-relaxed text-body-color">
                    our service is to repair where and whenever you are, order now and we will come to your place, we are waiting for your order soon
                </p>
                <div class="-mx-3 flex flex-wrap">
                    <div class="w-1/2 px-3">
                        <button @click="modalOpen = false" class="block w-full rounded-lg border border-[#E9EDF9] p-3 text-center text-base font-medium text-dark transition hover:border-red-600 hover:bg-red-600 hover:text-white">
                            Just View
                        </button>
                    </div>
                    <div class="w-1/2 px-3">
                        <button class="block w-full rounded-lg border border-slate-800 bg-slate-800 p-3 text-center text-base font-medium text-white transition hover:bg-opacity-90">
                            Order
                        </button>
                    </div>
                </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                    <div class="mb-10 w-full">
                        ...
                        <p class="text-base text-body-color">&copy; 2023 FixStore</p>
                    </div>
                </div>
            </div>
        </div>
