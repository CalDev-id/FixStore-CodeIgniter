 ...
 -->
    ...
    <section class="is-hero-bar">
      <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
        ...
        <button class="button light"><a href="/pesan">Tambah Pesanan</a></button>
      </div>
    </section>
            ...
            <tbody>
              <?php foreach ($orders as $order) : ?>
                <tr>
                  ...
                  <td><?= $order['address']; ?></td>
                  <td><?= $order['damage_details']; ?></td>
                  
                  <td><?= $order['car_type']; ?></td>
                  <td><?= $order['handleby']; ?></td>
                  <td class="actions-cell">
                    <div class="buttons right nowrap">
                      <button class="button small blue --jb-modal" type="button">
                        <span class="icon"><a href="/orders/edit/<?= $order['id']; ?>"><i class="mdi mdi-eye"></i></a></span>
                      </button>
                      <button class="button small red --jb-modal" type="button">
                        <span class="icon"><a href="/orders/delete/<?= $order['id']; ?>"><i class="mdi mdi-trash-can"></i></a></span>
                      </button>
                    </div>
                  </td>
